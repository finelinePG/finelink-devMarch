...
if(Mage::helper('core')->isModuleEnabled('AdjustWare_Deliverydate')){
    class Aitoc_Aitcheckoutfields_Model_Rewrite_AdminSalesPdfInvoice_Aittmp extends AdjustWare_Deliverydate_Model_Rewrite_AdminSalesPdfInvoice {}
}else{
    /* default extends start */
    class Aitoc_Aitcheckoutfields_Model_Rewrite_AdminSalesPdfInvoice_Aittmp extends Mage_Sales_Model_Order_Pdf_Invoice {}
    /* default extends end */
}

/* AITOC static rewrite inserts end */

class Aitoc_Aitcheckoutfields_Model_Rewrite_AdminSalesPdfInvoice extends Aitoc_Aitcheckoutfields_Model_Rewrite_AdminSalesPdfInvoice_Aittmp
{
