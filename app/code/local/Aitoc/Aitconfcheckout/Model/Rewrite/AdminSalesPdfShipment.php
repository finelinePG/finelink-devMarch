...
if(Mage::helper('core')->isModuleEnabled('AdjustWare_Deliverydate')){
    class Aitoc_Aitconfcheckout_Model_Rewrite_AdminSalesPdfShipment_Aittmp extends AdjustWare_Deliverydate_Model_Rewrite_AdminSalesPdfShipment {}
 }else{
    /* default extends start */
    class Aitoc_Aitconfcheckout_Model_Rewrite_AdminSalesPdfShipment_Aittmp extends Mage_Sales_Model_Order_Pdf_Shipment {}
    /* default extends end */
}
...
class Aitoc_Aitconfcheckout_Model_Rewrite_AdminSalesPdfShipment extends Aitoc_Aitconfcheckout_Model_Rewrite_AdminSalesPdfShipment_Aittmp
{
    /**
